...
namespace SecApi
{
    public sealed class Client : IDisposable
    {
        ...
        public Client(string apiAuthToken,string endpoint)
        {
            ...
            _apiAuthToken = apiAuthToken.Trim();
        ...
        public async Task<string> GetCompanyAsync(string companyId)
        {
            if (companyId == null)
            ...
            var url = "https://api.sec-api.io/mapping/cik/" + companyId+ "?token=" + _apiAuthToken;
        ...
        public async Task<string> FindCompaniesAsync(string query)
        {
            if (query == null)
                throw new ArgumentNullException(nameof(query));
            
            string url = "https://api.sec-api.io?token="+ _apiAuthToken;
            var reqContent = new StringContent(query, Encoding.UTF8, JsonMimeType);
